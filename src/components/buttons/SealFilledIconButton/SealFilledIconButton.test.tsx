...
describe('SealFilledIconButton', () => {
  it('renders without error with minimal props', () => {
    renderWithTheme(<SealFilledIconButton.Primary icon={Rocket} tooltip="Launch" />)
  ...
  describe('compound sub-components', () => {
    it('renders Primary without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.Primary icon={Rocket} tooltip="primary" />,
      )
    ...
    it('renders Accent without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.Accent icon={Rocket} tooltip="accent" />,
      )
    ...
    it('renders AccentSecondary without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.AccentSecondary icon={Rocket} tooltip="accent-secondary" />,
      )
    ...
    it('renders Gradient without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.Gradient icon={Rocket} tooltip="gradient" />,
      )
    ...
    it('renders AccentGradient without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.AccentGradient icon={Rocket} tooltip="accent-gradient" />,
      )
    ...
    it('renders Custom without crashing', () => {
      const { unmount } = renderWithTheme(
        <SealFilledIconButton.Custom icon={Rocket} color="#f00" tooltip="custom" />,
      )
  ...
  it('shows loading spinner when loading is true', () => {
    renderWithTheme(<SealFilledIconButton.Primary icon={Rocket} tooltip="Loading" loading />)
  ...
  it('disables interaction when disabled prop is true', async () => {
    const onClick = vi.fn()
    renderWithTheme(
      <SealFilledIconButton.Primary icon={Rocket} tooltip="Disabled" disabled onClick={onClick} />,
    )
  ...
  it('calls onClick when interacted with', async () => {
    const onClick = vi.fn()
    renderWithTheme(
      <SealFilledIconButton.Primary icon={Rocket} tooltip="Action" onClick={onClick} />,
    )
  ...
  it('respects the title prop over tooltip prop', () => {
    renderWithTheme(
      <SealFilledIconButton.Primary icon={Rocket} title="Title text" tooltip="Tooltip text" />,
    )
