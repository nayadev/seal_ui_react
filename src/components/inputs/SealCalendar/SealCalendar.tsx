...
// Replaces shadcn CalendarDayButton: removes bg-primary dependency (not in Seal token system)
// and applies --seal-brand-primary CSS variables for all selection states.
    ...
    <button
      ...
      className={cn(
        ...
        modifiers.today === true &&
          !modifiers.selected &&
          'bg-[var(--seal-surface-surface-alt)] font-style-title',
...
const SEAL_CALENDAR_CLASSNAMES = {
  months: 'relative flex flex-col gap-dimension-md md:flex-row',
  month: 'flex w-full flex-col gap-dimension-md',
  month_caption: cn(
    'flex h-[var(--cell-size)] w-full items-center justify-center px-[var(--cell-size)]',
    'text-[var(--seal-text-primary)] font-style-title',
  ),
  nav: 'absolute inset-x-0 top-0 flex h-[var(--cell-size)] w-full items-center justify-between gap-dimension-xxs',
