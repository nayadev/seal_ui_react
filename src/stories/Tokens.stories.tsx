  ...
  return (
    ...
    >
      ...
      <Section title="Gradients">
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
          {(['primary', 'accent', 'surface', 'surface-primary', 'surface-accent'] as const).map(
            (g) => (
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Visual catalog of all SealUI design tokens. Use the Theme/Mode toolbar above to switch themes.',
      },
    },
  },
}
